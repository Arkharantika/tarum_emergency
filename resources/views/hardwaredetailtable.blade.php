                    ...
                    <div class="container mt-3">
                            ...
                            <form action="{{url('/hardwaredaterange/'.$chance)}}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="btn-group col-6 col-sm-3 mb-1" role="group" style="height:40px">
                                        ...
                                        <button class="btn btn-success btn-sm" title="Export Normal"
                                            formaction="{{url('/exportdata/'.$chance)}}"><i class='bx bxs-download'></i>
                                            </button>
                                        <button class="btn btn-info btn-sm" title="Export All"
                                            formaction="{{url('/exportcontoh/'.$chance)}}"><i class='bx bxs-download'></i>
                                            </button>
                                        <button class="btn btn-secondary btn-sm" title="Export Monthly"
                                            formaction="{{url('/exportmonthly/'.$chance)}}"><i class='bx bxs-download'></i>
                                            </button>
                                        <button class="btn btn-dark btn-sm" title="Export Yearly"
                                            formaction="{{url('/exportyearly/'.$chance)}}"><i class='bx bxs-download'></i>
                                            </button>
                                    </div>
                        ...
                        <div class="text-center mt-2 mb-2 ">
                            <button class="btn-outline-dark border" disabled><b>Q</b><sub>Debit</sub> =
                                <b>a<sub>1</sub></b>*(TMA)<sup>2</sup> + <b>b<sub>2</sub></b>*(TMA) + <b>c<sub>3</sub></b>
                                &nbsp || &nbsp (<b>K</b> TMA : {{$recorddetail->k_tma}})&nbsp || &nbsp(<b>a<sub>1</sub></b> :
                                {{$recorddetail->k1}}), (<b>b<sub>2</sub></b> :
                                {{$recorddetail->k2}}), (<b>c<sub>3</sub></b> :
                                {{$recorddetail->k3}})</button>
                        </div>
                            ...
                            <table id="example2" class="table table-striped table-bordered text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        $b = $recorddetail->k2;
                                        $c = $recorddetail->k3;
                                        // $Q = ($a * (pow($row->nilai, 2))) + ($b * $row->nilai) + $c; 
                                        $Q = $a * (pow($row->nilai, 2)) + ($b * $row->nilai) + $c; 
